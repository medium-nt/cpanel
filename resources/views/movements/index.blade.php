    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('movements.create') }}" class="btn btn-primary mr-3 mb-3">Добавить новое поступление</a>
                            ...
                            <tr>
                                ...
                                <td style="width: 100px">
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('movements.edit', ['movement' => $movement->id]) }}" class="btn btn-primary mr-1">
