...
class WriteOffRemnantServiceTest extends TestCase
{
    ...
    //
    //        // Create a named mock to avoid alias conflicts
    //        $inventoryServiceMock = Mockery::mock('overload:'.InventoryService::class);
    //        $inventoryServiceMock
    //            ->shouldReceive('remnantsMaterialInWarehouse')
    //            ->with($material->id)
    //            ->andReturn($quantity + 5);
    //
    ...
    //
    //        // Create overload mock to avoid alias conflicts
    //        $inventoryServiceMock = Mockery::mock('overload:'.InventoryService::class);
    //        $inventoryServiceMock
    //            ->shouldReceive('remnantsMaterialInWarehouse')
    //            ->with($material->id)
    //            ->andReturn($availableQuantity);
    //
    //        $request = new StoreRemnantsRequest([
    //            'material_id' => [$material->id],
