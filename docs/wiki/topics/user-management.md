...
- `cleaner` (уборщица) — минимальный доступ, не участвует в сменах, не видит
  модули склада/маркетплейса/производства, но имеет доступ в киоск любого цеха
  только для учёта рабочего времени
